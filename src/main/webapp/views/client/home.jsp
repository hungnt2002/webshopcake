...
<jsp:include page="header.jsp"></jsp:include>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="shop-cat-box">
                    <img class="img-fluid" src="resource/images/bonglantrung.jpg" alt="" /> <a class="btn hvr-hover" href="#"> Xem</a>
                </div>
            </div>
        </div>
    </div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid" src="resource/images/viewshop1.jpg" alt="" />
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid" src="resource/images/viewshopp.jpg" alt="" />
					</div>
				</div>
			</div>
		</div>
