...
<html lang="en">
  ...
  <head>
    ...
    <!-- Custom CSS -->
    <link
      href="<c:url value='/resource/css/custom.css ' />"
      rel="stylesheet"
    />
          ...
          <div class="col-lg-4 col-sm-12">
            <div class="contact-info-left">
              ...
              <ul>
                <li>
                  <p>
                    <i class="fas fa-map-marker-alt"></i>Địa chỉ: 33/354 Trần
                    Cung <br />Bắc Từ Liêm,<br />
                ...
                <li>
                  <p>
                    ...
                    <a href="tel:+1-888705770">0373831172</a>
                  </p>
                </li>
                <li>
                  <p>
