			...
			<div class="row">
				<div class="col-lg-6">
					<div class="banner-frame">
						<img class="img-fluid" src="resource/images/about.jpg"
							alt="" />
					</div>
				</div>
				<div class="col-lg-6">
					...
					<div class="hover-team">
						<div class="our-team">
							...
							<div class="team-content">
								<h3 class="title">Nam Nguyen</h3>
								<span class="post">Web Developer</span>
							</div>
							<ul class="social">
								<li><a href="https://www.facebook.com/nam970901" class="fab fa-facebook"></a></li>
								<li><a href="https://www.linkedin.com/in/ndnam0109" class="fab fa-twitter"></a></li>
								<li><a href="github.com/ndnam0109" class="fab fa-github"></a></li>
								<li><a href="https://www.instagram.com/namnguyen.0109" class="fab fa-instagram"></a></li>
							</ul>
							<div class="icon">
						...
						<div class="team-description">
							<p>
								Đam mê, yêu thích công nghệ.<br /> Thành thạo : Java Core<br />
								Hiểu biết: Jsp/Servlet, CSS, HTML, JS, MySQL<br /> Công cụ:
								Elipse, VS Code, GitHub<br /> Mục tiêu: Web Developer FullStack
							</p>
						</div>
						<hr class="my-0">
					</div>
