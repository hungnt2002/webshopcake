...
<link href="<c:url value='/resource/css/responsive.css ' />"
	rel="stylesheet">
<!-- Custom CSS -->
<link href="<c:url value='/resource/css/custom.css ' />"
	rel="stylesheet">
	...
	<div id="slides-shop" class="cover-slides">
		<ul class="slides-container">
			<li class="text-center"><img
				src="resource/images/anhbiabanhngot3.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
			...
			<li class="text-center"><img
				src="resource/images/banner-01.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
			...
			<li class="text-center"><img
				src="resource/images/anhbiabanhngot4.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="shop-cat-box">
                    <img class="img-fluid" src="resource/images/cperesaurieng.jpg " alt="" />
                    <a class="btn hvr-hover" href="#">Xem</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="shop-cat-box">
                    <img class="img-fluid" src="resource/images/banhngot1.jpg " alt="" /> <a class="btn hvr-hover" href="#">Xem</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="shop-cat-box">
                    <img class="img-fluid" src="resource/images/banhbonglantrungmuoi.jpg" alt="" /> <a class="btn hvr-hover" href="#"> Xem</a>
                </div>
            </div>
        </div>
    </div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid" src="resource/images/add-img-01.jpg" alt="" />
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid" src="resource/images/add-img-02.jpg" alt="" />
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-3 col-md-6 special-grid best-seller">
					<div class="products-single fix">
						<div class="box-img-hover">
							...
							<img src="resource/images/banhman/banhbonglantrung.jpg"
				...
				<div class="col-lg-3 col-md-6 special-grid top-featured">
					<div class="products-single fix">
						<div class="box-img-hover">
							...
							<img
								src="resource/images/banhman/banhbonglantrungmuoi.jpg"
								class="img-fluid" alt="Image">
							<div class="mask-icon">
								<ul>
									<li><a href="#" data-toggle="tooltip"
				...
				<div class="col-lg-3 col-md-6 special-grid best-seller">
					<div class="products-single fix">
						<div class="box-img-hover">
							...
							<img src="resource/images/banhman/sli12.jpg"
								class="img-fluid" alt="Image">
							<div class="mask-icon">
								<ul>
									<li><a href="#" data-toggle="tooltip"
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-lg-4 col-xl-4">
					<div class="blog-box">
						<div class="blog-img">
							<img class="img-fluid" src="resource/images/blog-img.jpg" alt="" />
						</div>
				...
				<div class="col-md-6 col-lg-4 col-xl-4">
					<div class="blog-box">
						<div class="blog-img">
							<img class="img-fluid" src="resource/images/blog-img-01.jpg" alt="" />
						</div>
						<div class="blog-content">
							<div class="title-blog">
								<h3>Fusce in augue non nisi fringilla</h3>
